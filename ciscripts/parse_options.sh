...
function print_usage {
  ...
  echo -e "      All valid platforms are \"arm_android_32\", \"arm_android_64\",
       -e        \"arm_linux_32\", \"arm_linux_64\", \"x86_linux\", \"all\"."
  ...
  echo -e "      The default is false."
  echo -e "  --build_threads=n: Build with n threads. Default is 1."
}
...
while true; do
  ...
  case "$1" in
    --platform=*) parse_platform "$1"; shift 1;
      ;;
    --use_openmp=*) use_openmp=parse_bool "$1"; shift 1;
      ;;
    --use_openmp) use_openmp=true; shift 1;
      ;;
    --use_opencl=*) use_opencl=parse_bool "$1"; shift 1;
      ;;
    --use_opencl) use_opencl=true; shift 1;
      ;;
    --use_opengl=*) use_opengl=parse_bool "$1"; shift 1;
      ;;
    --use_opengl) use_opengl=true; shift 1;
      ;;
    --use_vulkan=*) use_vulkan=parse_bool "$1"; shift 1;
      ;;
